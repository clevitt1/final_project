    ...
    output$plot3 <- renderPlotly({
     ...
     output$plot5 <- renderPlotly({
      ...
      geom_density(col = "red") +
        ylab("Density") + xlab("Estimated wOBA Value") + labs(title = "Density Plot of wOBA Values")
