...
server<-shinyServer(function(input,output){
    ...
    output$models<-renderDataTable({
      ...
      mod_svm_rad<-train(estimated_woba_using_speedangle~pfx_x+pfx_z+effective_speed+release_speed+release_spin_rate, data=swing_data(), method="svmRadial", preProc=c("center","scale"), tuneLength=10, trControl=cv_opts )
      acc_svm<-max(mod_svm_rad$results$Accuracy)
